window.addEventListener('DOMContentLoaded', async function() {
    ...
    document.querySelectorAll('.repo-card').forEach(async function(el) {
      ...
      el.innerHTML = `
      <div style="font-family: 'Baloo Paaji', cursive; -apple-system,BlinkMacSystemFont,Segoe UI,Helvetica,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji; padding: 16px; font-size: 14px; line-height: 1.5; color: #24292e;">
        ...
        <div style="display: ${data.fork ? 'block' : 'none'}; font-size: 12px; color: #586069;">Forked from <a style="color: inherit; text-decoration: none;" href="${data.fork ? data.source.html_url : ''}" target="_blank">${data.fork ? data.source.full_name : ''}</a></div>
